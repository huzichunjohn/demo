...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blog', '0005_remove_blogaudit_action'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_user', audit_log.models.fields.LastUserField(related_name='_product_audit_log_entry', editable=False, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
